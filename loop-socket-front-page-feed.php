...
<div id="each-post-news-stack" class="post" id="post-<?php the_ID(); ?>"><!-- start #each-post-->
	...
	<div id="each-post-news-stack-content">
	
	<div id="each-post-news-stack-1"><!-- start #each-post-news-stack-1-->
	...
	<div id="each-post-news-stack-2"><!-- start #each-post-news-stack-2-->
	...
	<div id="each-post-news-stack-3"><!-- start #each-post-news-stack-3-->	
