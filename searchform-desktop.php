...
<form method="get" id="search-form-desktop" class="tnsf tnsf-m" action="<?php bloginfo('home'); ?>/">
	...
	<input type="text"  tabindex="0" placeholder="Search ARK" value="<?php echo wp_specialchars($s, 1); ?>" name="s" id="search-box-desktop" class="tnsfsb tnsfsb-m tnsfsb-blue-border" />	
</form>
